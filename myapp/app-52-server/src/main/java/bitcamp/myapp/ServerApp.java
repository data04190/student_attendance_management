...
public class ServerApp {
  ...
  public ServerApp(int port) throws Exception {
    ...
    this.attendanceDao = new MySQLAttendanceDao(sqlSessionFactory);
  ...
  private void prepareMenu() {
    ...
    attendanceMenu.add(new Menu("등록", new AttendanceAddListener(attendanceDao, sqlSessionFactory)));
    ...
    attendanceMenu
        .add(new Menu("변경", new AttendanceUpdateListener(attendanceDao, sqlSessionFactory)));
    attendanceMenu
        .add(new Menu("삭제", new AttendanceDeleteListener(attendanceDao, sqlSessionFactory)));
