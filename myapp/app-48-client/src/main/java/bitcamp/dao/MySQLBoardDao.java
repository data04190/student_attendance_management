...
public class MySQLBoardDao implements BoardDao {
  ...
  @Override
  public int getMemberLevel(String writer) {
  ...
  public List<Board> list() {
    try (PreparedStatement stmt = con.prepareStatement(
        "select b.board_no, b.title, b.writer, b.view_count, b.created_date from myapp_board b inner join myapp_member m"
  ...
  public int delete(Board board) {
    try (PreparedStatement stmt =
        con.prepareStatement("delete from myapp_board where board_no=? and password=sha1(?)")) {
