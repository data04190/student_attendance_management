...
public class DispatcherServlet extends HttpServlet {
  ...
  public void init() throws ServletException {
    ...
    controllerMap.put("/attendance/list", new AttendanceListController(attendanceDao));
    controllerMap.put("/attendance/add", new AttendanceAddController(attendanceDao, sqlSessionFactory, ncpObjectStorageService));
    controllerMap.put("/attendance/detail", new AttendanceDetailController(attendanceDao));
    controllerMap.put("/attendance/update", new AttendanceUpdateController(attendanceDao, sqlSessionFactory, ncpObjectStorageService));
    controllerMap.put("/attendance/delete", new AttendanceDeleteController(attendanceDao, sqlSessionFactory));
